    ...
    <div class="container" id="container">
        <div class="form-container sign-up-container">
            <form method="POST" action="{{ route('register') }}">
                ...
                <input type="text" placeholder="Name" name="name" required autofocus autocomplete="name" />
        ...
        <div class="form-container sign-in-container">
            <form method="POST" action="{{ route('login') }}">
                ...
                <h1>Përshëndetje!</h1>
                <hr>
                <span>Hyr në llogarinë tuaj!</span>
        ...
        <div class="overlay-container">
            <div class="overlay">
                <div class="overlay-panel overlay-left">
                    ...
                    <p>Keni llogari ekzistuese?</p>
                    <button class="ghost" id="signIn">Hyr tani</button>
                </div>
                <div class="overlay-panel overlay-right">
                    <h1>Nuk keni llogari?</h1>
                    <p>Vendosni te dhënat tuaja dhe bëhuni pjesë e jona!</p>
                    <button class="ghost" id="signUp">Krijo tani</button>
                </div>
            </div>
        </div>
    </div>
